                ...
                <div class="lesson2011">
                    <table>
                                ...
                                <span class="exlinksp1">
                                    <%
                                        if (Report.Score < 60)
                                        {
                                            ...
                                            if (Report.Compulsory >= 40 && Report.Elective >= 1.5m)
                                            { %>
                                    ...
                                    <script type="text/javascript">
                                        function msg_for_exam() {
                                            alert("必修必须全部学完，必修加选修至少学41.5课时方可参加考试！");
                                        }
                                    </script>
                        ...
                        <tr style="background-color: #f8f3f3">
                            <td colspan="6" style="text-align: left">* 必修必须全部学完，必修加选修至少学41.5课时方可参加考试，通过考试(60分)后可打印本年度证书。
                                <br />
                                * 考试通过后，请刷新本页查看最新成绩。
                            </td>
                        </tr>
