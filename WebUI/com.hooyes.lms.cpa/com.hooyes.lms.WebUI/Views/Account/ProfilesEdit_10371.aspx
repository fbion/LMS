                ...
                <form id="profile_form">
                    <table id="invoicetb" style="width: 100%" class="commontb signup-tb">
                        ...
                        <tr>
                            <td class="t">身份证号</td>
                            <td>
                                <input id="Text4" name="IDCard" type="text" class="s-text required IDCard" maxlength="18" value="<%=member.IDCard %>" /></td>
                        </tr>
                        <tr>
                            <td class="t">所在地区</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                              <%--  <select id="s_year" class="required">
                                ...
                                <%--<input id="Text10" name="Birthday" type="text" class="Wdate s-text required date" maxlength="30" value="<%=member.Birthday.ToString("yyy-MM-dd") %>" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', qsEnabled: false, minDate:'<%=DateTime.Now.AddYears(-80)%>',maxDate:'<%=DateTime.Now%>' })" />--%>

                                <input id="Text10" name="Birthday" type="text" class="s-text required Date" maxlength="30" value="<%=member.Birthday.ToString("yyyy-MM-dd") %>" />格式：1980-06-08
                        ...
                        <tr>
                            <td class="t">职称等级</td>
                            <td>
                                <input id="Text5" name="Job" type="text" class="s-text required" maxlength="15" value="<%=member.Job %>" />
                            </td>
                        </tr>
                        <tr>
                            <td class="t">学历</td>
                        ...
                        <tr>
                            <td class="t">学位</td>
                            <td>
                                <input id="Text13" name="Degree" type="text" class="s-text required" maxlength="10" value="<%=member.Degree %>" />
                            </td>
                        </tr>
                        <tr>
                            <td class="t">所学专业</td>
