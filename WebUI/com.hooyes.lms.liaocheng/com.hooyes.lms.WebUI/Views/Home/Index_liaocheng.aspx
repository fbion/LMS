...
<head>
    ...
    <link href="<% = CDN_Private %>/Css/r/liaocheng.css?t=20150505" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="loginFlow" style="height: auto; padding: 0px 0px 0px 0px; margin-top: 163px">
                <div class="about-flow">
                    <ul class="ul-content">
                        <li class="t">课程试听：</li>
                        <li class="c">
                            <p style="margin-top:13px;"><a href="http://static.online.nai.edu.cn/html/liaocheng/audition.html" target="_blank">课程试听列表</a></p>
                        </li>
                        <li class="t">学习需知：</li>
                        <li class="c">
                            <p>1、登录</p>
                            <p style="text-indent: 2em;">
                                未注册的学员请先注册，已注册的学员可以直接登录。
                            </p>

                            <p>2、选课/学习</p>

                            <p style="text-indent: 2em;">选择年度并使用充值卡充值后开通课程，选择课程进行学习，学满24学时后可进入考试环节。</p>
        ...
        <div class="loginSide">
            <div class="loginBlock" style="height: 277px">
                ...
                <div class="loginForm">
                    <form class="login_form" id="login_form" action="" onsubmit="return Login('/Account/landing')" method="post">
                        ...
                        <div class="loginBtn" style="margin-top:29px;">
            ...
            <div class="loginAbout" style="margin-top: 164px; background-position:center 10px; height: 385px">
            </div>
        </div>
