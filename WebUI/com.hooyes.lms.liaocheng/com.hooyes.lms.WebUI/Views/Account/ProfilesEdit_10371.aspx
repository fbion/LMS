                        ...
                        <tr>
                            ...
                            <td>
                              <%--  <select id="s_year" class="required">
                                ...
                                <input id="Text10" name="Birthday" type="text" class="Wdate s-text required date" maxlength="30" value="<%=member.Birthday.ToString("yyy-MM-dd") %>" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd', qsEnabled: false, minDate:'<%=DateTime.Now.AddYears(-80)%>',maxDate:'<%=DateTime.Now%>' })" /></td>
                        </tr>
                        <tr>
                            <td class="t">民族</td>
                            <td>
