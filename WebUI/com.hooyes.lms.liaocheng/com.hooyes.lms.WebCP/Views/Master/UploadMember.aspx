...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>导入学员 <a href="../Content/Template/T21.xls">下载模板</a></h2>
    <div id="Container">
            ...
            <form action="../file/CommonFileSave" method="post" enctype="multipart/form-data" onsubmit="return uConfirm()">
                <ul class="c-ul">
                    ...
                    <li style="display:none">
                        Tag:<input type="text" name="tag" value="member" /></li>
                    <li style="display:none">Next:<input type="text" name="nextAction" value="UploadMemberPreview" /></li>
                    <li>
