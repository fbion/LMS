    ...
    public class Get
    {
        ...
        public static List<M1> M1(string keyword, int AID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(C.conn, CommandType.StoredProcedure, "M_Get_Member", param);
                while (dr.Read())
                {
                    var m = new M1();
        ...
        public static List<M1> M1(int PageSize, int CurrentPage, out int Count)
        {
            ...
            try
            {
                ...
                SqlDataReader dr = SqlHelper.ExecuteReader(C.conn, CommandType.StoredProcedure, "M_Get_MemberList", param);
                while (dr.Read())
                {
                    var m = new M1();
                    m.ID = Convert.ToInt32(dr["ID"]);
        ...
        public static List<M1> M1(int PageSize, int CurrentPage, string Filter, out int Count)
        {
            ...
            try
            {
                ...
                var oCount = SqlHelper.ExecuteScalar(C.conn, CommandType.StoredProcedure, "M_Get_MemberListCount", param2);
        ...
        public static List<M2> M2(int PageSize, int CurrentPage, out int Count)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(C.conn, CommandType.StoredProcedure, "M_Get_InvoiceList", param);
                while (dr.Read())
                {
                    var m = new M2();
                ...
                dr.Close();
                //取总记录
                var oCount = SqlHelper.ExecuteScalar(C.conn, CommandType.StoredProcedure, "M_Get_InvoiceListCount");
        ...
        public static List<M2> M2(int PageSize, int CurrentPage, string Filter, out int Count)
        {
            ...
            try
            {
                ...
                var oCount = SqlHelper.ExecuteScalar(C.conn, CommandType.StoredProcedure, "M_Get_InvoiceListCount", param2);
        ...
        public static List<Incomes> Incomes(int PageSize, int CurrentPage, string Filter, out int Count)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(C.conn, CommandType.StoredProcedure, "M_Get_IncomesList", param);
                while (dr.Read())
                {
                    var m = new Incomes();
                ...
                var oCount = SqlHelper.ExecuteScalar(C.conn, CommandType.StoredProcedure, "M_Get_IncomesListCount", param2);
        ...
        public static List<Model.M.Survey> Survey(int PageSize, int CurrentPage, string Filter, out int Count)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(C.conn, CommandType.StoredProcedure, "M_Get_SurveyList", param);
                while (dr.Read())
                {
                ...
                var oCount = SqlHelper.ExecuteScalar(C.conn, CommandType.StoredProcedure, "M_Get_SurveyListCount", param2);
        ...
        public static List<Model.M.AdminMenu> AdminMenu(int AID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(C.conn, CommandType.StoredProcedure, "M_Get_AdminMenu", param);
                while (dr.Read())
                {
        ...
        public static List<Model.M.Region> Region(int AID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(C.conn, CommandType.StoredProcedure, "M_Get_Region", param);
                while (dr.Read())
                {
        ...
        public static Admin Admin(int AID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(C.conn, CommandType.StoredProcedure, "M_Get_Admin", param);
                if (dr.Read())
                {
