...
<head>
    ...
    <meta name="description" content="宁夏会计人员网络继续教育学习系统使用指导手册，北京国家会计学院是国务院于1998年7月20日批准成立的国务院事业单位，由财政部代管，教学管理依托清华大学。培训会计人才的后续教育培训基地。" />
    <title>宁夏会计人员继续教育 -- 指导手册 -- 国家会计学院</title>
...
<body>
    <div id="wrapper">
        ...
        <div class="help">
            <h2 class="title">宁夏会计人员网络继续教育学习系统使用指导手册</h2>
            <div>
                <h3>一、	报名缴费</h3>
                <p class="text">
                    1、进入北京国家会计学院远程教育网宁夏会计人员继续教育学习专区（网址：<a class="link" target="_blank" href="http://ningxia.nai.edu.cn">ningxia.nai.edu.cn</a>）。点击登录框下方蓝色的注册按钮开始报名。
                </p>
                <p class="img">
                ...
                <p class="text">
                    4、返回到宁夏学习专区首页，填写身份证号码、姓名进行登录。登录后选择购买内容，系统生成购买订单。
                </p>
                <p class="img">
        ...
        <div class="footer">
            <span>宁夏财政厅</span><span> 技术支持：<a href="http://www.nai.edu.cn" target="_blank">北京国家会计学院</a>
            </span>
