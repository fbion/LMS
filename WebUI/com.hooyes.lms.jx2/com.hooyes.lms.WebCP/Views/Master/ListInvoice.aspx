...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <table class="commontb">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ~
                        <input type="text" name="MaxAmount" id="MaxAmount" value="1000" maxlength="5" class="shortinput" />
                    </td>
                </tr>
                 <tr>
                    <td>序号</td>
                    <td>
                        <input type="text" name="MinID" id="MinID" value="0" maxlength="10" class="shortinput" />
                        ~
                        <input type="text" name="MaxID" id="MaxID" value="0" maxlength="10" class="shortinput" />
                    </td>
                </tr>
            </table>
        </form>
    ...
    <table id="Table2" class="commontb">
        ...
        <tr class="<%=oddClass %>">
            ...
            <td>
              ...
              <%--  <a href="ViewInvoice?MID=<%=m.MID %>&IID=<%=m.IID %>&Year=<%=m.Year %>" target="_blank"><% = m.Name %> </a>--%>
            ...
            <td>
                ...
                <% 
               if (m.Title.Length > 12)
               {
                   string sTitle = "<a class='anone' onmouseover=\"showTipper('#{0}_1')\">{1}...</a>";
                   sTitle = string.Format(sTitle, m.IID, m.Title.Substring(0, 12));
            ...
            <td>
                ...
                <% 
               if (m.NameContact.Length > 10)
               {
                   string NameContact = "<a class='anone' onmouseover=\"showTipper('#{0}_3')\">{1}...</a>";
                   NameContact = string.Format(NameContact, m.IID, m.NameContact.Substring(0, 10));
            ...
            <td>
                ...
                <% 
               if (m.Address.Length > 25)
               {
                   string sAddress = "<a class='anone' onmouseover=\"showTipper('#{0}_2')\">{1}...</a>";
                   sAddress = string.Format(sAddress, m.IID, m.Address.Substring(0, 25));
    ...
    <script type="text/javascript">
        ...
        function ResetSearchForm() {
            var data = { "Years": null, "MinAmount": 0, "MaxAmount": 0, "MinID": 0, "MaxID": 0, "CrMinDate": "\/Date(-62135596800000)\/", "CrMaxDate": "\/Date(-62135596800000)\/", "QueryFlag": 1 };
            InitData(data);
        }
        $(function () {
            InitData(JsonStr);
