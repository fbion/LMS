                ...
                <div class="lesson2011">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<%=com.hooyes.lms.C.APP %>/Account/Contents/<%= c.CID %>" target="_blank"><span class="icon_listen"></span>
                                </a>
                            </td>
                            <td>
                                <%= status%>
                        ...
                        <tr style="background-color: #f8f3f3">
                            <td colspan="6" style="text-align: left">* 学满 1080 分钟后可参加考试，考试合格分为60分，通过考试后可打印本年度证书。考试完请刷新本页查看最新成绩。</td>
                        </tr>
                    </table>
