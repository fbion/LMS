...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <table class="commontb signup-tb">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td class="t">会计师证号</td>
                        <td>
                            <input id="Text2" name="IDCert" type="text" class="s-text" maxlength="20" /></td>
                    </tr>
    ...
    <script src="<% = com.hooyes.lms.C.CDN %>/Scripts/signup.public.js?t=20131209" type="text/javascript"></script>
</asp:Content>
