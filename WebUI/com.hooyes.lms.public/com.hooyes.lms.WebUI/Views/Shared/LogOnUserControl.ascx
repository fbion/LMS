...
<div class="login_info">
    <ul>
        ...
        <li class="t_a_c linkli2"><a href="<% = com.hooyes.lms.C.APP %>/Account/MyProducts">【已购课程】</a></li>
        <li class="t_a_c linkli2"><a href="<% = com.hooyes.lms.C.APP %>/Payment/Buy">【购买课程】</a></li>
        <li class="t_a_c linkli2"><a href="<% = com.hooyes.lms.C.APP %>/Payment/OrdersList">【我的订单】</a></li>
        <li class="t_a_c linkli2"><a href="<% = com.hooyes.lms.C.APP %>/Account/Invoice">【申请发票】</a></li>
        <li class="t_a_c linkli2"><a href="<% = com.hooyes.lms.C.APP %>/Payment/Balance">【我的账户】</a></li>
<%--        <li class="t_a_c linkli2"><a href="<% = com.hooyes.lms.C.APP %>/Upload/Photo">【上传照片】</a></li>
        <li class="t_a_c linkli2"><a href="<% = com.hooyes.lms.C.APP %>/Account/Certificatev2" target="_blank">【查看证书】</a></li>--%>
