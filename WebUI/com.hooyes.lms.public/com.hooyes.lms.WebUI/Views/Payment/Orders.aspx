        ...
        <div id="right">
            ...
            <form id="OrderForm" action="<% = com.hooyes.lms.C.APP %>/Payment/Pay" method="post" target="_blank" onsubmit="return ShowTip();">
                ...
                <div class="board board3 paybanner paybanner2">
                    <%--  <ul class="paydetail">
                        <li>订单金额：￥<span id="orderamout" class="amount"><%=Math.Round(Order.Amount, 2)%></span></li>
                        <li>学习卡抵扣 -￥  <span id="Span1" class="amount"> <%=Math.Round(Order.Credit, 2)%></span></li>
                        <li>余额：-￥  <span id="creditamout" class="amount"> <%=Math.Round(Order.Credit, 2)%></span></li>
                        <li>应付总额：￥  <span id="cashamount" class="orderamount"><%=Math.Round(Order.Cash, 2)%> </span></li>
                    </ul>--%>
