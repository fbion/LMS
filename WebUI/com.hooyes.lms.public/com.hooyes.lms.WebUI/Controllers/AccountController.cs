...
namespace com.hooyes.lms.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult LearningX(int id)
        {
            ...
            ////提交成绩
            //if (Report.Status == 1 && Report.Minutes >= 1080 && Report.Flag == 0)
            //{

            //    var rApi = DAL.Task.CommitReport(Client.MID, id);
        ...
        public ActionResult Landing()
        {
            ...
            string Url = C.APP + "/Account/MyProducts";
            //if (member.Level == -1)
            //{
        ...
        public ActionResult MyProducts()
        {
            ...
            var MyProducts = DAL.Get.MyProductsFull(Client.MID);
            //ViewData["Products"] = Products.FindAll(n => n.MyID <= 0);
            ViewData["My_Products"] = MyProducts;
            return View();
        }
    }
}
