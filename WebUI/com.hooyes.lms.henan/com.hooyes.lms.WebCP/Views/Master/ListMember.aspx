        ...
        <form action="" method="get">
            ...
            for (int i = CurrentYear; i >= StartYear; i--)
            {
                ...
                <tr>
                    <td>结业时间</td>
                    <td>
                        <input type="text" name="GrMinDate" id="GrMinDate" class="Wdate" maxlength="20" onclick="WdatePicker()" />
                        ~
                        <input type="text" name="GrMaxDate" id="GrMaxDate" class="Wdate" maxlength="20" onclick="WdatePicker()" />
                    </td>
                </tr>
                <tr>
                    <td>考试分数
    ...
    <script type="text/javascript">
        ...
        function InitData(data) {
            ...
            if (data.QueryFlag == 1) {
                ...
                $("#GrMinDate").val(data.GrMinDate.toCustomDate());
                $("#GrMaxDate").val(data.GrMaxDate.toCustomDate());
        ...
        function ResetSearchForm() {
            var data = { "Type": -1, "Years": null, "MaxMinutes": 0, "MinMinutes": 0, "MinScore": 0, "MaxScore": 0, "Status": -1, "IID": -1, "RegMinDate": "\/Date(-62135596800000)\/", "RegMaxDate": "\/Date(-62135596800000)\/", "GrMinDate": "\/Date(-62135596800000)\/", "GrMaxDate": "\/Date(-62135596800000)\/", "QueryFlag": 1 };
            InitData(data);
        }
