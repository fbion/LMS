...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="SurveyContainer" class="survey-container">
        <div class="survey-subject">培训效果调查表  -- 学员建议</div>
        <div class="survey-tip" style="margin-bottom:1px;height:20px;">
            <div class="survey-al-link">
                <a href="../Survey/Summary">查看投票结果</a>
            </div>
        </div>
        ...
        <%
            ...
            var ListM = com.hooyes.lms.DAL.M.Get.SurveyRecordsText(PageSize, CurrentPage, Filter, out TotalRecords);
        ...
        <div id="Pager1" class="Pager">
            <%--<div class="total">总条数  <%= TotalRecords%></div>--%>
            <span class="export">

                <a href="../Export/SurveyFeedBack?PageSize=<%=TotalRecords %>&CurrentPage=0&<%=QueryString %>">[导出全部]</a>
                <a href="../Export/SurveyFeedBack?PageSize=<%=PageSize %>&CurrentPage=<%= CurrentPage%>&<%=QueryString %>">[导出本页]</a>
            </span>
            每页
            <%= PageSize%>
