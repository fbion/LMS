...
<body>
            ...
            <div class="rightcontent2">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listtab2">
                    ...
                    <tr>
                        ...
                        <td nowrap="nowrap">
                            <span class="flashlink blue-txt">
                                <a class='media-b mr-10' href="javascript:ViewCourse(<%= Contents[i].CID %>,<%= Contents[i].CCID %>,'<%= Contents[i].MIME %>');">窄带</a>
                            </span>
                            <span class="flashlink blue-txt">
                                <a class='media-a mr-10' href="javascript:ViewCourse(<%= Contents[i].CID %>,<%= Contents[i].CCID %>,'<%= Contents[i].MIME %>');">宽带</a>
                            </span>
                        </td>
                    </tr>
                    <%
    ...
    <script type="text/javascript">
        function ViewCourse(cid, ccid, MIME) {
            var url = "Player?cid=" + cid + "&ccid=" + ccid;
            if (MIME == "video/mp4") {
                url = "PlayerHD?cid=" + cid + "&ccid=" + ccid;
            }
