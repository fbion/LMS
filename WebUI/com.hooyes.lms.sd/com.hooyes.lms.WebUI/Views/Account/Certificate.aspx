...
<body>
    <div id="Container" class="Container">
        ...
        <div id="Certificate" class="Certificate">
            <div class="title">山东会计人员远程继续教育合格证书</div>
            <div class="content">
                <span class="nick"><%=com.hooyes.lms.Client.Name %></span> (<%=com.hooyes.lms.Client.IDCard %>) 于 <%=BeginDate %>至 <%=EndDate %>参加北京国家会计学院组织的山东会计人员远程继续教育培训，已修完规定学时并且考试通过，予以结业，特发此证。
                <%--<p>
