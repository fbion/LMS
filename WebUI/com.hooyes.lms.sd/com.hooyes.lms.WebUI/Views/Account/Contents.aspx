...
<body>
            ...
            <div class="rightcontent2">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="listtab2">
                    ...
                    <tr>
                        ...
                        <td nowrap="nowrap">
                            <span class="flashlink blue-txt"><a class='media-b mr-10' href="javascript:ViewCourse(<%= Contents[i].CID %>,<%= Contents[i].CCID %>);">高清</a> </span>
    ...
    <script type="text/javascript">
        function ViewCourse(cid, ccid) {
            var url = "<% = com.hooyes.lms.C.APP %>/Account/PlayerHD?cid=" + cid + "&ccid=" + ccid;
