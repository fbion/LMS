...
<head>
    ...
    <link href="<% = CDN_Private %>/Css/r/daqing.css?t=20150505" rel="stylesheet" type="text/css" />
            ...
            <div class="loginFlow" style="height: auto; padding: 0px 0px 0px 0px; margin-top: 163px">
                <div class="about-flow">
                    <ul class="ul-content">
                        ...
                        <li class="c">
                            <p>
                                各位学员：每个年度缴费方式均为网银，2015年度35元/人，以往年度补学每年度80元/人，请学员登陆账号后使用网银缴费激活，如有集团客户统一付费激活，请转账汇款至以下账户，并在备注栏备注“大庆市会计人员继续教育”，汇款成功后将学员名单（身份证号码、姓名、报名年度）、发票抬头、收件人、收件地址及联系方式发邮件至：study@nai.edu.cn。
                                <br />单位名称：北京国家会计学院
                                <br />开户行：建设银行北京天竺支行
                                <br />账号：11001020100056030985
                                <br />行号：105100015049
                            </p>
                            <p>
                                2015年大庆市会计人员继续教育网络培训工作从6月15日开始至10月31日结束。
                            </p>
                            <p>
                                根据新的规定，会计从业资格证有效期为6年。已经到期的会计从业资格证需要重新换证。
                                请登录<a href="http://dqkjw.daqing.gov.cn/" target="_blank">大庆会计网</a>查看具体换证文件。
                        ...
                        <li class="c">
                            ...
                            <p>5、缴费方式</p>
<p style="text-indent: 2em;">
    缴费方式为网银，2015年度35元/人，以往年度补学每年度80元/人，请登陆后使用网银缴费激活，集团客户统一付费，请直接转账至以下账户，并在备注栏备注“远程教育”，汇款成功后请将学员名单（身份证号码、姓名、报名年度）、发票抬头、收件人、收件地址及联系方式发邮件至：study@nai.edu.cn。 
    <br />单位名称：北京国家会计学院 
    <br />开户行：建设银行北京天竺支行 
    <br />账号：11001020100056030985 
    <br />行号：105100015049 
...
<p>6、培训日期</p>
<p style="text-indent: 2em;">2015年培训日期为6月15日至10月31日。会计证有效期为6年。请登录大庆会计网查看具体换证文件。 
</p>
 <p>7、学习流程</p>
<p style="text-indent: 2em;"> <a href="http://static.online.nai.edu.cn/html/daqing/大庆会计人员继续教育学习流程.docx" target="_blank">大庆会计人员继续教育学习流程.docx </a>
</p>
        ...
        <div class="loginSide">
                ...
                <div class="loginForm">
                    <form class="login_form" id="login_form" action="" onsubmit="return Login('/Account/landing')" method="post">
                        ...
                        <div class="loginInt" id="passWord">
                            密码：<span class="login-tips">姓名</span>
                            <input type="text" value="" placeholder="" class="loginInput" id="PWD" name="PWD" tabindex="2" />
                        </div>
            ...
            <div id="login_notice" class="loginAbout" style="margin-top: 164px; background-position: center 10px; min-height:300px">
                <div class="side-notice" style="margin-top: 150px">
                    <ul>
                        <li class="head">通知：</li>
                        <li><a href="http://dqkjw.daqing.gov.cn/Content.aspx?newsGuid=392eec3d-adf6-4c91-a627-bd5542b1d92d" target="_blank">2015年度会计人员继续教育的通知</a></li>
                    </ul>
                </div>
            </div>
