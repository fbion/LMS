    ...
    public class ASPState
    {
        ...
        public static R InSessions(string SessionId)
        {
            ...
            try
            {
                ...
                var r = SqlHelper.ExecuteScalar(SqlHelper.ASPState, CommandType.Text, Sql, param);
                m.Code = 0;
        ...
        public static R KillPrevSessions(string SessionId)
        {
            ...
            try
            {
                ...
                var r = SqlHelper.ExecuteNonQuery(SqlHelper.ASPState, CommandType.Text, Sql, param);
                m.Code = 0;
