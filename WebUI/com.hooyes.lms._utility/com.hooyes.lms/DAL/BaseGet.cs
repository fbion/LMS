    ...
    public class BaseGet
    {
        ...
        public static Member Member(int MID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_Member", param);
                if (dr.Read())
                {
                    m.Code = 0;
                    m.MID = MID;
        ...
        public static List<Contents> Contents(int CID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_Contents", param);
                while (dr.Read())
                {
                    var m = new Contents();
        ...
        public static List<MyCourses> MyCourses(int MID, int Year, int Type)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_MyCoursesList", param);
                while (dr.Read())
                {
                    var m = new MyCourses();
                    m.CID = Convert.ToInt32(dr["CID"]);
        ...
        public static List<Question> MyPaper(int MID, int Year, int CID)
        {
        ...
        public static List<MyConents> Contents(int MID, int CID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_MyContents", param);
                while (dr.Read())
                {
                    var m = new MyConents();
                    m.CID = CID;
        ...
        public static List<Courses> CoursesList(int Year, int Type)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_CoursesList", param);
                while (dr.Read())
                {
                    var m = new Courses();
                    m.CID = Convert.ToInt32(dr["CID"]);
        ...
        public static List<Member> Member()
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_MemberList", param);
                while (dr.Read())
                {
                    var m = new Member();
                    m.Code = 0;
        ...
        public static Products Products(int MID, int PID)
        {
            var m = new Products();
            try
            {
        ...
        public static List<MyProducts> MyProducts(int MID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_MyProducts", param);
                while (dr.Read())
                {
        ...
        public static List<Report> MyReport(int MID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_MyReport", param);
                while (dr.Read())
                {
                    var m = new Report();
                    m.ID = Convert.ToInt32(dr["ID"]);
        ...
        public static Courses Courses(int CID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_Courses", param);
                if (dr.Read())
                {
                    m.CID = CID;
        ...
        public static MyCourses Courses(int MID, int CID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_MyCourses", param);
                if (dr.Read())
                {
                    m.CID = CID;
                    m.MID = MID;
        ...
        public static Report Report(int MID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_Report", param);
                if (dr.Read())
                {
                    m.ID = Convert.ToInt32(dr["ID"]);
                    m.MID = Convert.ToInt32(dr["MID"]);
        ...
        public static MSessions MSessions(int MID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_MSessions", param);
                if (dr.Read())
                {
                    m.Code = 0;
                    m.MID = MID;
        ...
        public static Order Order(int MID, int ID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_Order", param);
                if (dr.Read())
                {
                    m.ID = ID;
        ...
        public static Balance Balance(int MID)
        {
            ...
            try
            {
                ...
                var _r = SqlHelper.ExecuteNonQuery(SqlHelper.Local, CommandType.StoredProcedure, "Get_Balance", param);
        ...
        public static R CheckPhone(int MID, int Year, string Phone)
        {
            ...
            try
            {
                ...
                param[1].Direction = ParameterDirection.Output;
                param[2].Direction = ParameterDirection.Output;
                int _r = SqlHelper.ExecuteNonQuery(SqlHelper.Local, CommandType.StoredProcedure, "Check_Phone", param);
        ...
        public static R CheckHours(int MID)
        {
            ...
            try
            {
                ...
                param[1].Direction = ParameterDirection.Output;
                param[2].Direction = ParameterDirection.Output;
                int _r = SqlHelper.ExecuteNonQuery(SqlHelper.Local, CommandType.StoredProcedure, "Check_Hours", param);
                r.Code = Convert.ToInt32(param[1].Value);
                r.Message = Convert.ToString(param[2].Value);
                r.Value = Convert.ToInt32(param[0].Value);
            }
        ...
        public static Results AvailableInvoiceCash(int MID)
        {
            ...
            try
            {
                ...
                param[1].Direction = ParameterDirection.Output;
                param[2].Direction = ParameterDirection.Output;
                var _r = SqlHelper.ExecuteScalar(SqlHelper.Local, CommandType.StoredProcedure, "Get_InoviceCash", param);
                r.Code = Convert.ToInt32(param[1].Value);
                r.Message = Convert.ToString(param[2].Value);
        ...
        public static Certificate Certificate(int MID)
        {
            ...
            try
            {
                ...
                var dr = SqlHelper.ExecuteReader(SqlHelper.Local, CommandType.StoredProcedure, "Get_Certificate", param);
                if (dr.Read())
                {
                    m.ID = Convert.ToInt32(dr["ID"]);
                    m.MID = Convert.ToInt32(dr["MID"]);
