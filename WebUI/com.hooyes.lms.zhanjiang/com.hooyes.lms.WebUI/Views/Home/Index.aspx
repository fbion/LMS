                ...
                <div style="width: 100%; border-bottom: 1px solid #DEDEDE;">
                    ...
                    <div style="width: 620px; height: 460px; padding: 10px;">
                        <div id="noticeContent" style="font-size: 13px; line-height: 25px">
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;北京国家会计学院远程教育网“湛江会计人员继续教育”网络学习开始，现开设<span style="color: red;">2013</span>和<span style="color: red;">2014</span>两个年度的“<span style="color: red;">大中企业类、小企业类、行政事业类</span>”三类课程的学习。达标学时为24学时，考试为综合考试，收费标准：<span style="color: red;">2013年度120元/人，2014年度96元/人。</span></p>
                            <p>
                            ...
                            <p>
                                2.湛江市会计人员继续教育学习流程
							<a target="_blank" href="/index.php/Help">(点击进入)</a>
                            </p>
                            ...
                            <br>
                            <p style="color: red;">温馨提示：广大学员在继续教育完成学习时间并参加考试后，请于一周左右登录广东省会计信息服务平台上查询您的继续教育完成信息。</p>
